<form method="POST" action="functions/processEdit.php" class="mt-4">
            ...
            <div class="row justify-content-center mt-4">
                <button type="submit" class="btn btn-xl custom-btn w-45 color-red me-3">Zapisz zmiany</button>
                <a href="bookings.php" class="btn btn-xl custom-btn w-45 color-red">Anuluj</a>
            </div>
</form>